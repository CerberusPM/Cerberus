...
| **Command and usage**                                                                                 | **Permission**                                                                                                                                                              | **Description**                                                                                                                                                                     |
|-------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| `/cerberus flag <land name> <flag name> <true/false>`                                                 | `cerberus.command.flag`                                                                                                                                                     | Base permission for setting flags                                                                                                                                                   |
| `/cerberus help`                                                                                      | `cerberus.command.help`                                                                                                                                                     | Get available commands and usage information                                                                                                                                        |
| `/cerberus here`                                                                                      | `cerberus.command.here`                                                                                                                                                     | Displays what ladclaim a player stands on                                                                                                                                           |
| `/cerberus info <land name>`                                                                          | `cerberus.command.info`                                                                                                                                                     | Provides information about a specific land claim                                                                                                                                    |
| `/cerberus list [player name]`                                                                        | `cerberus.command.list`<br/>`cerberus.command.list.other`                                                                                                                   | Lists owned land claims <br/>Allows listing land claims of other players                                                                                                            |
| `/cerberus remove <land name>`                                                                        | `cerberus.command.remove`<br/>`cerberus.command.remove.other`                                                                                                               | Removes an owned land claim <br/>Allows removing land claims owned by other players                                                                                                 |
| `/cerberus pos1 [x y z] [world]`, `/pos2 [x y z] [world]`, `/cerberus expand <up|down|vert> [blocks]` | `cerberus.command.selection`                                                                                                                                                | Allows position selection, wand selection, movement, and expansion (expands all the way up, down or both if no blocks specified                                                     |
| `/cerberus setspawn <land name> [x y z]`                                                              | `cerberus.command.setspawn`<br/>`cerberus.command.setspawn.other`                                                                                                           | Sets a spawn point for a land claim <br/>Allows setting spawn points for land claims owned by others                                                                                |
| `/cerberus teleport <land name> [player name]`                                                        | `cerberus.command.teleport`<br/>`cerberus.command.teleport.other`                                                                                                           | Teleports to a claim's spawn point <br/>Allows teleporting other players to landclaim's spawn point                                                                                 |
| `/cerberus addmember <land name> <player name>`                                                       | `cerberus.command.addmember`<br/>`cerberus.command.addmember.other`                                                                                                         | Permission for /cerberus addmember<br/>Permission to add members to landclaims owned by other players                                                                               |
| `/cerberus addowner <land name> <player name>`                                                        | `cerberus.command.addowner`<br/>`cerberus.command.addowner.other`                                                                                                           | Permission for /cerberus addowner<br/>Permission to add owners to landclaims owned by other players                                                                                 |
| `/cerberus removemember <land name> <player name>`                                                    | `cerberus.command.removemember`<br/>`cerberus.command.removemember.other`                                                                                                   | Permission for /cerberus removemember<br/>  Permission to remove members from landclaims owned by other players                                                                     |
| `/cerberus removeowner <land name> <player name>`                                                     | `cerberus.command.removeowner`<br/>`cerberus.command.removeowner.other`                                                                                                     | Permission for /cerberus removeowner<br/>Permission to remove owners from landclaims owned by other players                                                                         |
| `/cerberus unsetspawn <land name>`                                                                    | `cerberus.command.unsetspawn`<br/>`cerberus.command.unsetspawn.other`                                                                                                       | Removes a spawn point from a land claim <br/>Allows removing spawn points from land claims owned by others                                                                          |
| `/cerberus wand`                                                                                      | `cerberus.command.wand`                                                                                                                                                     | Gives you a selection tool                                                                                                                                                          |
| `/cerberus reload`                                                                                    | `cerberus.command.reload`                                                                                                                                                   | Reloads the plugin configuration, landclaims and language files                                                                                                                     |
...
| Invincible    | invincible  | Prevent all kinds of damage                                      | cerberus.flag.invincible                                       | god, invincibility, nodamage, no_damage                                                                            |                               
| NoPVP         | no_pvp      | Prevent PVPing                                                   | cerberus.flag.no_pvp <br>cerberus.flag.no_pvp.bypass           | pvp, nofight, fight, stoppvp, stop_pvp, no_fight, antipvp, anti_pvp                                                |

NoBreak, NoPlace and NoInteract are turned on by default for all newly created landclaims. This can be tuned in config.yml
...
version: 1.0-DEV-65 # For internal use. Don't touch!
```
...
+ Fix land creation, listing, etc. errors for console
* Move subcommand
* Flag scope (decide, which flags are applied to which groups (owners, members, guests))
* Add more flags
